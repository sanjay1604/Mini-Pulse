...
public class MiniPulseDBImpl implements MiniPulseDB {
    ...
    public void saveResponse(Response response) {
        ...
        try (Connection con = getConnection();
             PreparedStatement insRespSt = con.prepareStatement(insertResponseQuery)) {

            insRespSt.setString(1, response.getResponseId());
            insRespSt.setString(2, response.getPollId());
            insRespSt.setString(3, response.getAnswer());
            insRespSt.executeUpdate();
    ...
    private Connection getConnection() throws SQLException {
        ...
        return DriverManager.getConnection("", "sanjay", "sruthi");
    }
}
