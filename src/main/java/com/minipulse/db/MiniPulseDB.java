                        ...
                        try
                            {
                                    ...
                                    insPollst.executeUpdate();
                                     ...
                                     for (Poll.Question question : poll.getQuestions()) {
                                                insertQuesnst.setString(1, poll.getId());
                                                insertQuesst.setString(2, question.getId());
                                                insertQuesst.setString(3, question.getText());
                                                insertQuesst.addBatch();
                                            }
                                            insertQuesst.executeBatch();
